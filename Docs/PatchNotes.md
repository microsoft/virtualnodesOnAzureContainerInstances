...
- Added `nodePoolIdentityFallbackEnabled`, which can be set to `false` to enforce use of Workload Identity instead of falling back to the AKS nodepool identity 🪪
